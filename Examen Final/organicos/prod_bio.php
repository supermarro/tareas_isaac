...
$titulo_pagina = "Muebles";
$bio= mysql_query("SELECT * FROM biodegradables");
?>
<head>
...
.redes
{
	...
	margin-right:10px;
        ...
        <div id="banner">
<div id="boton"><h2 id="titulo">	BIODEGRADABLES</h2></div>
        </div><!--CIERRE BANNER -->
...
<div id="seccion">
	<?php
            while($fila = mysql_fetch_array($bio)){
				echo "<div class='cuadro'>". "<img src='img/biodegradables/".$fila[imagen]."'/>";
