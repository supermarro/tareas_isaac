...
$med= mysql_query("SELECT * FROM med_nat");
?>
<head>
...
.redes
{
	...
	margin-right:10px;
        ...
        <div id="banner">
<div id="boton"><h3 id="titulo">MEDICAMENTOS NATURALES</h3></div>
        </div><!--CIERRE BANNER -->
...
<div id="seccion">
		<?php
            while($fila = mysql_fetch_array($med)){
				echo "<div class='cuadro'>". "<img src='img/medicina/".$fila[imagen]."'/>";
