...
$muebles= mysql_query("SELECT * FROM muebles");
?>
<head>
...
.redes
{
	...
	margin-right:10px;
        ...
        <div id="banner">
<div id="boton"><h2 id="titulo">MUEBLES</h2></div>
        </div><!--CIERRE BANNER -->
...
<div id="seccion">
<?php
            while($fila = mysql_fetch_array($muebles)){
				echo "<div class='cuadro'>". "<img src='img/muebles/".$fila[imagen]."'/>";
